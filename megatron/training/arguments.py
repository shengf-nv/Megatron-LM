...
def _add_inference_args(parser):
    ...
    group.add_argument('--cuda-graph-scope', nargs='+', type=str, default=["full"],
                       help='Determines the CUDA graphs capturing scope. '
                       'choices: "full", "attn", "mlp", "moe", "moe_router", "moe_preprocess", "mamba", "full_iteration". '
                       '"full": captures all scopes. '
